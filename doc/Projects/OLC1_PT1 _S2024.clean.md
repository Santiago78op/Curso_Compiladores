...
Catedráticos: Ing. Manuel Castillo, Ing. Kevin Lajpop, Ing. Mario Bautista
Tutores académicos: Fabian Reyna, Carlos Acabal, Xhunik Miguel

# ConjAnalyzer — Proyecto 1
...
| ^(A U B) = ^A ∩ ^B | Leyes de DeMorgan |
| ^(A ∩ B) = ^A U ^B | Leyes de DeMorgan |
| A U B = B U A | Propiedades conmutativas |
| A ∩ B = B ∩ A | Propiedades conmutativas |
| A U (B U C) = (A U B) U C | Propiedades asociativas |
| A ∩ (B ∩ C) = (A ∩ B) ∩ C | Propiedades asociativas |
| A U (B ∩ C) = (A U B) ∩ (A U C) | Propiedades distributivas |
| A ∩ (B U C) = (A ∩ B) U (A ∩ C) | Propiedades distributivas |
| A U A = A | Propiedades idempotentes |
| A ∩ A = A | Propiedades idempotentes |
| A U (A ∩ B) = A | Propiedades de absorción |
| A ∩ (A U B) = A | Propiedades de absorción |
